...
// });
console.log('-----')
  request({url:'https://www.myntra.com/mobile-accessories/nikkispride/marble-mobile-stand/13404382/buy',headers:{'User-Agent' : 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_5) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.89 Safari/537.36'},verify=False}, function (error, response, body) {
  console.log('-----myntra----');
  console.error('error:', error); // Print the error if one occurred
  console.log('statusCode:', response && response.statusCode); // Print the response status code if a response was received
  // console.log('body:', body); // Print the HTML for the Google homepage.
